...
## Method1
•Run the wsgi.py file (python wsgi.py)
...
Setup for Web3 : 
 ```
 1. Register yourself on Metamask Dev as wel as Client side.
 2. Sepolia Website (ETH) for testing the hash keys. 
 3. To get free testing credits, visit : alchemy.com

 Note : Paste API Key and Client Private Key in .env 